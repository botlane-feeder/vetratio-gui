<script lang="ts">
  ...
  myList.subscribe((list)=>{localList = list["oil"];});

  function addFood(){
    myList.addFood(categorie, oilFoodArray[selectValue]);
  }
